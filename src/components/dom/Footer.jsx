  ...
  return (
    ...
    >
          ...
          <div>
            <div className={styles.link}>
              <Link
                ...
                scroll={false}
                href="mailto:khushal.singh1123@gmail.com"
              >
                <h4 className={clsx(styles.email, 'h4')}>
                  khushal.singh1123@gmail.com
                </h4>
              </Link>
      ...
      <div className={styles.middleContainer} style={{ gridColumn: '1 / 9' }}>
        <AppearTitle isFooter>
          <div className="p-x">Based in Indore, India</div>
      ...
      >
        <AppearTitle isFooter>
          <div className="p-x">© 2025 · Khushal</div>
          <div className={clsx('p-x', styles.middleText)}>
            All Rights Reserved
          </div>
        </AppearTitle>
